...
// template<typename T>
// bool Square<T>::is_square(Point2D<T> const & first, Point2D<T> const & second, Point2D<T> const & third, Point2D<T> const & fourth) const {
//     double lens[6];
...
// template<typename T>
// Square<T>::Square(Point2D<T> const & first, Point2D<T> const & second, Point2D<T> const & third, Point2D<T> const & fourth) {
...
// template<typename T>
// Point2D<T> Square<T>::center() const noexcept {
//     Point2D<T> center;
...
//     return (are_equal(_first.x, sq._first.x) && are_equal(_first.y, sq._first.y) &&
//             are_equal(_second.x, sq._second.x) && are_equal(_second.y, sq._second.y) &&
//             are_equal(_third.x, sq._third.x) && are_equal(_third.y, sq._third.y) &&
//             are_equal(_fourth.x, sq._fourth.x) && are_equal(_fourth.y, sq._fourth.y));
// }
