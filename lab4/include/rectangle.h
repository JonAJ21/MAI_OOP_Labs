...
private:
    ...
    bool is_rectangle(Point2D<T> const & first, Point2D<T> const & second, Point2D<T> const & third, Point2D<T> const & fourth) const;

public: 
    explicit Rectangle() = default;
    explicit Rectangle(Point2D<T> const & first, Point2D<T> const & second, Point2D<T> const & third, Point2D<T> const & fourth);
    
    Point2D<T> center() const noexcept override;
...
template<typename T>
bool Rectangle<T>::is_rectangle(Point2D<T> const & first, Point2D<T> const & second, Point2D<T> const & third, Point2D<T> const & fourth) const {
    double lens[6];
...
template<typename T>
Rectangle<T>::Rectangle(Point2D<T> const & first, Point2D<T> const & second, Point2D<T> const & third, Point2D<T> const & fourth) {
...
template<typename T>
Point2D<T> Rectangle<T>::center() const noexcept {
    Point2D<T> center;
